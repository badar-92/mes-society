                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="current_courses" class="form-label">Current Degree-Subject *</label>
                                    <input type="text" class="form-control" id="current_courses" name="current_courses" placeholder="e.g., BS ME, BS Cs, MLT, etc " required>
                                </div>
                            </div>
                        </div>
                    </div>
