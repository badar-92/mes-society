    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="competition-details">
                <p class="lead"><?php echo formatDescription($competition['description']); ?></p>
                ...
                <?php if($competition['rules']): ?>
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p><?php echo formatDescription($competition['rules']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($competition['eligibility']): ?>
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p><?php echo formatDescription($competition['eligibility']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($competition['prize']): ?>
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p class="text-success"><?php echo formatDescription($competition['prize']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
