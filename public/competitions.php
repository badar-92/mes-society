...
function formatExcerpt($text, $length = 100) {
    // First truncate plain text (no HTML)
    ...
    // Now escape and apply formatting
                    ...
                    <div class="card h-100 shadow-sm competition-card">
                        ...
                        <?php if($competition['banner_image']): ?>
                            <img src="../uploads/competitions/<?php echo $competition['banner_image']; ?>" 
                                 class="card-img-top" alt="<?php echo htmlspecialchars($competition['title']); ?>" 
                        ...
                        <div class="card-body">
                            <!-- FIXED: Formatted excerpt -->
                            <p class="card-text"><?php echo formatExcerpt($competition['description'], 100); ?></p>
                            ...
                            <?php if($competition['rules']): ?>
                                <div class="mb-3">
                                    ...
                                    <p class="small"><?php echo formatExcerpt($competition['rules'], 150); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($competition['prize']): ?>
                                <div class="prizes-section">
                                    <h6>Prizes:</h6>
                                    <p class="small text-success"><?php echo formatExcerpt($competition['prize'], 150); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
