...
<section class="hero-section" style="background: url('uol-pic.jpg'); background-size: cover;
        ...
        <div class="row align-items-center min-vh-80">
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="/mes-society/public/apply.php" class="btn btn-warning btn-lg px-4">Join Our Society</a>
                    <a href="/mes-society/public/events.php" class="btn btn-outline-light btn-lg px-4">View Events</a>
                </div>
            </div>
            <div class="col-lg-6">
                <img src="/mes-society/assets/images/logo-mes.png" alt="MES Society" class="img-fluid rounded-3">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 bg-light" id="stats-section">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-3">
                <h2 class="display-4 fw-bold text-accent counter" data-target="250">0</h2>
                <p class="lead">Active Members</p>
            </div>
            <div class="col-md-3">
                <h2 class="display-4 fw-bold text-accent counter" data-target="80">0</h2>
            ...
            <div class="col-md-3">
                <h2 class="display-4 fw-bold text-accent counter" data-target="25">0</h2>
...
<section class="py-5">
    <div class="container">
                ...
                <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                    <div class="row justify-content-center">
                        <div class="col-md-8 text-center">
                            <img src="/mes-society/uploads/profile-pictures/<?php echo $member['profile_picture'] ?? 'default-avatar.png'; ?>" 
                                 alt="<?php echo $member['name']; ?>" 
                                 class="rounded-circle mb-4 team-avatar" 
                                 style="width: 200px; height: 200px; object-fit: cover;">
                            <h3 class="mb-2">
                                <?php echo $member['name']; ?>
                                <img src="verified-badge1.png" 
                                     alt="Verified Member" 
        ...
        <!-- Custom Indicators placed outside to avoid overlap -->
        <?php if (count($team_members) > 1): ?>
        <div class="carousel-indicators-custom text-center mt-4">
            <?php foreach($team_members as $index => $member): ?>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <img src="/mes-society/uploads/event-images/<?php echo $event['banner_image']; ?>" class="card-img-top" alt="<?php echo $event['title']; ?>" style="height: 200px; object-fit: cover;">
                    <?php else: ?>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="/mes-society/public/event-details.php?id=<?php echo $event['id']; ?>" class="btn btn-accent btn-sm mt-auto">View Details</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
        ...
        <div class="text-center mt-4">
            <a href="/mes-society/public/events.php" class="btn btn-primary">View All Events</a>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <img src="/mes-society/uploads/competitions/<?php echo $competition['banner_image']; ?>" class="card-img-top" alt="<?php echo $competition['title']; ?>" style="height: 200px; object-fit: cover;">
                    <?php else: ?>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="/mes-society/public/competition-details.php?id=<?php echo $competition['id']; ?>" class="btn btn-warning btn-sm mt-auto">View Details</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
        ...
        <div class="text-center mt-4">
            <a href="/mes-society/public/competitions.php" class="btn btn-outline-warning">View All Competitions</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="/mes-society/public/apply.php" class="btn btn-light btn-lg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (teamCarousel) {
        ...
        // Update custom indicators when carousel slides
        teamCarousel.addEventListener('slide.bs.carousel', function (event) {
    ...
    document.querySelectorAll('.custom-indicator').forEach(indicator => {
